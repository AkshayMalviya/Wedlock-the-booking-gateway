<%-- 
    Document   : planner
    Created on : Apr 25, 2017, 1:35:03 PM
    Author     : Aakash
--%>
...
<html>
   <head>
    ...
    <body>
        ...
        <h2 style="font-style: italic;font-size:40px;">Planner List</h2><br>
        ...
        <% 
            ...
            ResultSet resultset = 
                statement.executeQuery("select * from planner") ; 
        %>
        ...
        <TABLE >
            ...
            <TR>
                ...
                <td><lable for='asd'><input type="radio" name="planner"  id="asd" value=<%= resultset.getString(1)%> /></lable> </td>
